...
module.exports = function (eleventyConfig) {
  // Edit these to include your images, CSS, and other folders and files that you want to copy over to your misc folder.
  ...
  // These are the folders that Eleventy will use. "src" is where you edit files that Eleventy will then take in and export into "misc," which you upload.
    return {
      dir: {
        input: "src",
        output: "public",
